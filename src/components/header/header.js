	...
	return (
		<header>
			...
			<div className="container header__container">
				...
				<h1 className="text-light">I’m looking to <span className="white">level up my career</span> with any <span className="white">frontend</span> or <span className="white">full stack</span> opportunities. Let's <span className="white">connect</span> !! </h1>
				<CTA />
				{/* <div className="me">
